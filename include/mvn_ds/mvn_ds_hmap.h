...
// Sets a key-value pair in the hash map using an owned mvn_string_t key.
...
// Retrieves a pointer to the value associated with a given mvn_string_t key.
...
// Deletes a key-value pair from the hash map using an mvn_string_t key.
